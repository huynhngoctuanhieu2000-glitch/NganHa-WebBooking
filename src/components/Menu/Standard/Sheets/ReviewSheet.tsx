...
export default function ReviewSheet({ service, cart, isOpen, lang, onClose, onUpdateCart }: ReviewSheetProps) {
    ...
    return (
        <>
            ...
            <div
                className={`fixed inset-0 bg-black/60 z-[55] transition-opacity duration-300 ${isClosing ? 'opacity-0' : 'opacity-100'}`}
                onClick={handleClose}
            />
            ...
            <div
                className={`
          fixed bottom-0 left-0 w-full bg-[#111111] rounded-t-[30px] z-[60] overflow-hidden flex flex-col shadow-2xl
